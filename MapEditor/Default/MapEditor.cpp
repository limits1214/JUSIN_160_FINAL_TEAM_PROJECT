...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    RECT    rc{ 0,0, LONG(Client::g_iWinSizeX * fScaleFactor), LONG(Client::g_iWinSizeY * fScaleFactor) };
...
{
    if (E::CGameInstance::Get().ImguiWinProc(hWnd, message, wParam, lParam))
    {
        return true;
    }
    switch (message)
