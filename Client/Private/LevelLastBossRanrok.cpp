	...
	{
		{
			...
			TmbGurdianDesc.LevelTag = MagicEnumToStringView(LEVEL::LAST_BOSS_RANROK);
			...
			auto EliteTmb = E::CGameInstance::Get().AddGameObjectToLayer(LEVEL::LAST_BOSS_RANROK, PROTO_GAMEOBJECT::Prototype_GameObject_TMBGurdian, "02_TmbGurdian", &TmbGurdianDesc);
